...
class PDFComponentGenerationManager:
    ...
    def _set_pdf_font(self):
        ...
        regular_font_path = os.path.join(
            base_dir, "../", "static", "fonts", "Inter", "Inter_18pt-Regular.ttf"
        )
        bold_font_path = os.path.join(
            base_dir, "../", "static", "fonts", "Inter", "Inter_18pt-Bold.ttf"
        )
        italic_font_path = os.path.join(
            base_dir, "../", "static", "fonts", "Inter", "Inter_18pt-Italic.ttf"
        )
        boldItalic_font_path = os.path.join(
            base_dir, "../", "static", "fonts", "Inter", "Inter_18pt-BoldItalic.ttf"
        )
        ...
        pdfmetrics.registerFont(
            TTFont(name="InterBoldItalic", filename=boldItalic_font_path)
        )
